...
## Phase 9 — Strategic Visualizations (SWOT Bubble Chart + PESTEL Radar Upgrade)
...
## Phase 9B — UX Bug Fixes & Demo Loaders
...
## Phase 11 — Cross-Tab Polish (Interactive Charts + Calculations Button + WBS Cost View)
...
- [ ] SWOT 4D bubble chart with dropdown filter + green→red gradient (Phase 9)
- [ ] PESTEL radar interactivity + bubble overlay (Phase 9)
- [ ] Z-score table from `ztable_stats.csv` in BOTH Probability AND Three-Point tabs (Phase 10)
- [ ] Z-table path highlighting — forward Z→P and reverse P→Z with real-time data linking (Phase 10)
- [ ] "📊 Show All Calculations" button on every calculator tab, UG mode (Phases 10 + 11)
- [ ] Hybrid interactive charts (matplotlib static + Plotly "🔍 Open Interactive") on all chart tabs (Phase 11)
- [x] Plotly embedded renderer toggle on all 13 chart tabs via WebView2 (Phase 12) ✅
- [ ] WBS cost display mode + flat table view, UG mode (Phase 11)
- [ ] WBS ↔ Cost Estimation bidirectional link + top-down allocation (Phase 11)
