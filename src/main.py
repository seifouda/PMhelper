...
def main():
    ...
    try:
        ...
        if hasattr(
                app,
                'input_tab') and hasattr(
                app.input_tab,
                'get_activities_data'):
            print(
                f"Sample activities loaded: {len(app.input_tab.get_activities_data())}")
        else:
            print(
                "Sample activities loaded: [InputTab or get_activities_data not found]")
