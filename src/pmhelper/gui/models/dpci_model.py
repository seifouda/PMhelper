...
class DPCIAssessment:
    ...
    # Dimension scores (0-4 each, but each dimension has 4 criteria, so total
    # is 0-16 per dimension)
    ...
    def get_average_score(self) -> float:
        ...
        return (self.pdr_score + self.or_score +
                self.tr_score + self.er_score) / 4.0
    ...
    def get_pm_recommendations(self) -> Dict[str, Any]:
        ...
        if risk_level == RiskLevel.CRITICAL:
            ...
            actions.append(
                "Consider splitting into smaller, manageable projects")
        ...
        if self.pdr_score >= 12:
            actions.append(
                "📋 PDR: Invest significantly in requirements gathering")
        if self.or_score >= 12:
        ...
        if self.er_score >= 12:
            actions.append(
                "🌍 ER: Build in flexibility for environmental changes")
    ...
    def get_pm_recommendations(assessment: DPCIAssessment) -> List[str]:
        ...
        if risk_level == RiskLevel.CRITICAL:
            recommendations.append(
                "⚠️ CRITICAL: Requires exceptional PM expertise")
            ...
            recommendations.append(
                "✓ LOW RISK: Basic PM experience acceptable")
        ...
        if avg_score >= 3.0:
            ...
            recommendations.append(
                "📊 Methodology: Hybrid approach recommended")
        else:
            recommendations.append(
                "📊 Methodology: Predictive/Waterfall suitable")
