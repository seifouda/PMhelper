...
class ServerTab:
    ...
    def create_info_section(self):
        ...
        info_frame = ttk.LabelFrame(self.server_frame, text="Server Mode Information", padding="10")
...
Monitor server performance and active jobs using the Dashboard.
    ...
    def get_server_status_info(self) -> dict:
        ...
        return {
            ...
            "docs_url": f"{self.get_server_url()}/docs" if self.is_server_running() else None,
            "active_jobs": len(self.dashboard.active_jobs) if self.dashboard else 0,
