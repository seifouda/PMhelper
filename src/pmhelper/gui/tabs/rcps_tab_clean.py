...
class RCPSTab:
    ...
    def run_rcps(self):
        ...
        try:
            ...
            self.display_hybrid_schedule_view(
    ...
    def display_hybrid_schedule_view(
            self,
            parent,
            cpm_table,
            rcps_table,
        ...
        """
        # Create main container with 2 columns (left: tables, right: gantt
        # charts)
        ...
        # Tables column - fixed size based on content
        main_frame.grid_columnconfigure(0, weight=0)
        # Gantt column - fills remaining space
        ...
        self.display_compact_table_fixed_width(
            main_frame, cpm_compact, "Initial CPM-based Plan", col=0, row=0)
        self.display_compact_table_fixed_width(
            main_frame,
            rcps_compact,
    ...
    def display_compact_table_fixed_width(
        ...
        try:
            ...
            ttk.Label(
                frame,
                text="Table display requires tksheet package").grid(
                row=1,
                column=0)
