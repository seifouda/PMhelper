...
class FieldValidator:
    ...
    @staticmethod
    def validate_required(value: Any, field_label: str) -> Tuple[bool, Optional[str]]:
        """
    ...
    @staticmethod
    def validate_max_length(value: str, max_length: int, field_label: str) -> Tuple[bool, Optional[str]]:
        """
        ...
        if value and len(value) > max_length:
            return False, f"{field_label} cannot exceed {max_length} characters (currently {len(value)})"
        return True, None
    
    @staticmethod
    def validate_date(value: str, field_label: str) -> Tuple[bool, Optional[str]]:
        """
    ...
    @staticmethod
    def validate_number(value: str, field_label: str, min_value: Optional[float] = None, 
    ...
    @staticmethod
    def validate_currency(value: str, field_label: str) -> Tuple[bool, Optional[str]]:
        """
    ...
    @staticmethod
    def validate_email(value: str, field_label: str) -> Tuple[bool, Optional[str]]:
        """
