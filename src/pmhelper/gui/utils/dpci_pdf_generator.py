    ...
    def generate_pdf(assessment: DPCIAssessment, output_path: str) -> bool:
        ...
        try:
            ...
            story.append(Paragraph(
                "Design-Complexity Project Index Analysis",
                styles['Normal']
            ))
            ...
            dimensions_data = [
                ['Dimension', 'Score', 'Max', 'Percentage', 'Risk']]
            ...
            story.append(Paragraph(
                f"<b>Project Manager Level:</b> {pm_rec['level']}", styles['Normal']))
            story.append(Paragraph(pm_rec['description'], styles['Normal']))
            story.append(Spacer(1, 0.15 * inch))

            story.append(Paragraph(
                f"<b>Control Level:</b> {control_rec['level']}", styles['Normal']))
            story.append(
                Paragraph(
                    control_rec['description'],
                    styles['Normal']))
            ...
            for dim_key, dim_info in questionnaire.items():
                ...
                criteria_table = Table(
                    criteria_data, colWidths=[
                        3 * inch, 0.6 * inch, 3 * inch])
